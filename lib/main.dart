    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          CircleAvatar(
            radius: 60.0,
            backgroundImage: AssetImage('img/ulililala.jpg'),
          ),
          Text(
            "",
            style: TextStyle(
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: Text(
                "Kelas  : 5A SI Reguler Pagi (Banjarmasin)",
                style: TextStyle(
                  color: Colors.black,
                ),
              ),
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: Text(
                "Kontak : 140901ian@gmail.com (E-mail) | @rl.an14 (Instagram)",
                style: TextStyle(
                  color: Colors.black,
                ),
              ),
          ...
          Card(
            ...
            child: ListTile(
              ...
              title: Text(
                "Alamat : Jl. Ery Suparjan, Gg. Bersama, No.11a RT.43 ",
                style: TextStyle(
                  color: Colors.black,
                ),
              ),
